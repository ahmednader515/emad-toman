...
export default function HomePage() {
  ...
  return (
    <RecaptchaGate>
            ...
            {[
              {
                ...
                testimonial: "تجربة رائعة مع منصة د/عماد طمان، المحتوى غني والشرح مبسط"
              },
              {
                name: "سيف طارق",
      ...
      <motion.a
        href="https://www.facebook.com/emad.taman?rdid=7ieEpdXbNP6pMSXB&share_url=https%3A%2F%2Fwww.facebook.com%2Fshare%2F1NLicdVX1U%2F#"
        target="_blank"
        rel="noopener noreferrer"
        className="fixed bottom-6 right-6 z-50 bg-[#1877F2] hover:bg-[#166FE5] text-white rounded-full p-4 shadow-lg transition-all duration-300 flex items-center justify-center group"
